...
int, char*); int save_history(long int,long int,long int,long int,double*,
...
int midaco_print(int c, long int printeval, long int save2file, long int *iflag, 
				 ...
				 char *file_SCREEN, char *file_SOLUTION, char *file_HISTORY, char *file_PARETOFRONT)
{
/*CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC*/
...
{     
  ...
  *istop = 0;
  ...
  {
    iout1 = open_file( &*iout1, file_SCREEN);
    iout2 = open_file( &*iout2, file_SOLUTION);    
  }
  bestf[0] = 1.0e+99;
  bestr[0] = 1.0e+99;
  dummy_f   = 1.0e+99;
...
if(save2file >= 2){
                   ...
                   if(tix==1){ iout4 = open_file( &*iout4, file_HISTORY); }
         ...
         {           
             ...
             if( (bestr[0]  < dummy_vio)||
              ...
              if( o > 1 )
              {
                ...
                {
                print_paretofront(o,m,n,&*pf,&*bestx,&*bestg,pfmax,file_PARETOFRONT);
              }
            }          
         }
         }          
...
int print_paretofront(long int o, long int m, long int n, double *pf, 
                      double *x, double *g, int pfmax, char *fileName)
{
  long int psize = (long int)(pf[0]); int i,k; double dummy;
    ...
    iout3 = open_file( &*iout3, fileName); //"MIDACO_PARETOFRONT.TXT"
    fprintf(iout3,"#########################################################\n");
